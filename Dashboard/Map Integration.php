...
<div class="main">
    ...
    <div id="map" style="width:100%; height:400px; border-radius:15px; margin-bottom:20px;"></div>
...
<script>
    ...
    function viewPlace(placeName) {
        ...
        geocoder.geocode({ address: placeName + ", Philippines" }, function(results, status) {
            if (status === "OK") {
